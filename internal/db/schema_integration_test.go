...
var expectedForeignKeys = map[string]bool{
	...
	"loyalty_redemption_operations_user_id_fkey":  true,
	...
	"invoice_operations_actor_user_id_fkey":       true,
	"invoice_operations_order_id_fkey":            true,
	"invoice_operations_result_document_id_fkey":  true,
	"invoice_operations_target_document_id_fkey":  true,
	"invoice_preferences_order_id_fkey":           true,
	"order_events_actor_user_id_fkey":             true,
	"order_events_return_request_fk":              true,
	...
	"order_lines_product_id_fkey":                 true,
	"order_lines_variant_product_fk":              true,
	...
	"payment_intent_links_payment_id_fkey":        true,
	"stripe_refund_facts_local_refund_id_fkey":    true,
	"stripe_refund_facts_order_id_fkey":           true,
	"stripe_refund_facts_payment_id_fkey":         true,
	"refunds_previous_same_return":                true,
