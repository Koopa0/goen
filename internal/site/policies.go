		...
		Sections: []pages.PolicySection{
			{
				...
				Body: []string{
					...
					"登入時:工作階段保存 IP 位址及 User-Agent 瀏覽器資訊,用於登入安全與裝置辨識。",
				...
				BodyEn: []string{
					...
					"When you sign in: sessions store your IP address and User-Agent browser information for sign-in security and device identification.",
