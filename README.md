...
[goen.koopa0.dev](https://goen.koopa0.dev) runs it over the seeded catalogue in
`seed/`, with payments switched off, no mail leaving the machine, and the database
restored every night.
